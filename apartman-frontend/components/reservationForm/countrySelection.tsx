...
interface countryReference {
    countryRef: LegacyRef<HTMLSelectElement>;
}
const CountrySelection: React.FC<countryReference> = (props): ReactElement => {
    const{ countryRef } = props
  return (
            <select required className={Styles.select} ref={countryRef} id="country">
